...
datos_credito = {
    ...
    "plazo_meses": [67],
    "tipo_credito": [1],
    "saldo_inicial": [54000.75],
    "moneda": ['MXN', 'EUR', 'USD'],
    "num_pagos": [7, 10],
    "frecuencia_pagos": [7],
    "importe_pagos": [875.05],
    "fecha_ultimo_pago": ['08/10/2002'],
    "fecha_reestructura": ['05/11/2013'],
    "pago_efectivo": [1345.26],
    "fecha_liquidacion": ['23/11/2023'],
    "quita": [123.24, 4645.59],
    "dacion": [76547.767, 98651.25],
    "quebranto_castigo": [1234.45, 456757.57],
    "clave_observacion": ['Hola', 'Ejemplo'],
    "especiales": ['F'],
    "fecha_primer_cumplimiento": ['22/02/2000'],
    "saldo_insoluto": [200000.54, 85.01],
    "credito_maximo_utilizado": [123098.589],
