...
class ClaseEstilos:
    ...
    def agregarColumnasEncabezado(self, libro, hoja):
        ...
        hoja.write(1, 27, "Teléfono", self.agregarEstiloAzulClaro(libro))
        hoja.write(1, 28, "Extensión",self.agregarEstiloAzulClaro(libro))
        ...
        hoja.write(1, 50, "Teléfono", self.agregarEstiloAzulClaro(libro))
        hoja.write(1, 51, "Extensión", self.agregarEstiloAzulClaro(libro))
        hoja.write(1, 52, "Fax", self.agregarEstiloAzulClaro(libro))
        hoja.write(1, 54, "Edo extranjero", self.agregarEstiloAzulClaro(libro))
        hoja.write(1, 55, "País", self.agregarEstiloAzulClaro(libro))
        ...
        hoja.write(1, 71, "Fecha liquidación", self.agregarEstiloAzulClaro(libro))
        ...
        hoja.write(1, 75, "Clave observación", self.agregarEstiloAzulClaro(libro))
        hoja.write(1, 76, "Especiales", self.agregarEstiloAzulClaro(libro))
        hoja.write(1, 87, "CURP", self.agregarEstiloAzulClaro(libro))
        hoja.write(1, 100, "Teléfono", self.agregarEstiloAzulClaro(libro))
        hoja.write(1, 101, "Extensión", self.agregarEstiloAzulClaro(libro))
        hoja.write(1, 102, "Fax", self.agregarEstiloAzulClaro(libro))
        hoja.write(1, 104, "Edo extranjero", self.agregarEstiloAzulClaro(libro))
        hoja.write(1, 105, "País", self.agregarEstiloAzulClaro(libro))
        ...
        hoja.write(1, 7, "Versión", self.agregarEstiloAzulFuerte(libro))
        ...
        hoja.write(1, 16, "Calificación cartera", self.agregarEstiloAzulFuerte(libro))
        hoja.write(1, 17, "Clave Banxico 1/SCIAN", self.agregarEstiloAzulFuerte(libro))
        hoja.write(1, 20, "Dirección 1", self.agregarEstiloAzulFuerte(libro))
        hoja.write(1, 21, "Dirección 2", self.agregarEstiloAzulFuerte(libro))
        ...
        hoja.write(1, 32, "País", self.agregarEstiloAzulFuerte(libro))
        ...
        hoja.write(1, 44, "Dirección 2", self.agregarEstiloAzulFuerte(libro))
        ...
        hoja.write(1, 68, "Fecha último pago", self.agregarEstiloAzulFuerte(libro))
        ...
        hoja.write(1, 83, "Días vencidos", self.agregarEstiloAzulFuerte(libro))
        ...
        hoja.write(1, 88, "Nombre Compañia", self.agregarEstiloAzulFuerte(libro))
        ...
        hoja.write(1, 93, "Dirección 1", self.agregarEstiloAzulFuerte(libro))
        hoja.write(1, 94, "Dirección 2", self.agregarEstiloAzulFuerte(libro))
        ...
        hoja.write(1, 33, "Teléfono móvil", self.agregarEstiloGris(libro))
        hoja.write(1, 34, "Correo electrónico", self.agregarEstiloGris(libro))
